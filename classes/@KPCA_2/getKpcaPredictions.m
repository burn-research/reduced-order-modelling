function getKpcaPredictions(obj, varargin)
...
if k > size(obj.kriged_pca_scores, 1)
    k = size(obj.kriged_pca_scores, 1);
end
...
if ~obj.is_local || (obj.is_local && obj.is_mesh_variable)
    obj.kpca_predictions = obj.pca_decode(...
        obj.pca_modes(:,1:k), ...
        obj.kriged_pca_scores(1:k,:), ...
        obj.scaling_factors, ...
        obj.mean_column);
else
    obj.kpca_predictions = obj.pca_decode(...
