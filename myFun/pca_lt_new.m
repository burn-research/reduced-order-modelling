...
function [sort_eigval, sort_eigvec, ret_eigval, ret_eigvec, n_eig, U_scores, W_scores, gamma, scaled_data, rec_data] = pca_lt_new(raw_data, cent_crit, scal_crit, stop_rule, inputs)
